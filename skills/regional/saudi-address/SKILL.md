---
name: saudi-address
description: "العنوان الوطني — ابحث وتحقق من العناوين السعودية، حوّل إحداثيات لعنوان، واعثر على أقرب الخدمات. يستخدم واجهة العنوان الوطني الرسمية من البريد السعودي."
metadata: {"openclaw": {"emoji": "📍","requires": {"env": ["NATIONAL_ADDRESS_API_KEY"],"bins": ["curl"]},"category": "regional"}}
---
