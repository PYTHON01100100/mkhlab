---
name: tashkeel
description: "التشكيل — أضف الحركات (الفتحة، الضمة، الكسرة، السكون، الشدة، التنوين) على النصوص العربية. استخدم عندما يطلب المستخدم تشكيل نص."
metadata: {"openclaw": {"emoji": "🔤","requires": {"bins": ["curl"]},"category": "language"}}
---
