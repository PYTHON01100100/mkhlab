---
name: whisper-arabic
description: "تحويل الصوت لنص عربي — فرّغ ملفات صوتية عربية لنص مكتوب باستخدام Whisper. استخدم عندما يريد المستخدم تفريغ صوت أو فيديو عربي."
metadata: {"openclaw": {"emoji": "🎙️","requires": {"bins": ["whisper","ffmpeg"]},"category": "media"}}
---
