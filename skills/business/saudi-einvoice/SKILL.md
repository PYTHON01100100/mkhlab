---
name: saudi-einvoice
description: "الفوترة الإلكترونية (زاتكا) — إصدار فواتير إلكترونية والتحقق من الامتثال عبر منصة فاتورة. استخدم عندما يسأل المستخدم عن الفوترة الإلكترونية أو زاتكا أو فاتورة."
metadata: {"openclaw": {"emoji": "🧾","requires": {"env": ["ZATCA_API_KEY"],"bins": ["curl"]},"category": "business"}}
---
