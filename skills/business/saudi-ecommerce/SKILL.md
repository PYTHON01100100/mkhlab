...
description: "منصات التجارة الإلكترونية السعودية — ربط مع سلة وزد ونون عبر API. استخدم عندما يسأل المستخدم عن التجارة الإلكترونية أو سلة أو زد أو نون."
metadata: {"openclaw": {"emoji": "🛒","requires": {"bins": ["curl"]},"category": "business"}}
---
