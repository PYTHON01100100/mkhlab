---
name: saudi-food
description: "تقنيات المطاعم والتوصيل في السعودية — Saudi restaurant POS, food delivery APIs: Foodics, HungerStation, Jahez, Careem"
metadata: {"openclaw": {"emoji": "🍽️","requires": {"bins": ["curl"]},"category": "business"}}
---
