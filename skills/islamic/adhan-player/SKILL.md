---
name: adhan-player
description: "مشغّل الأذان — شغّل أذان بأصوات مؤذنين مختلفين (العفاسي، عبدالباسط، المجالي...). استخدم عندما يطلب المستخدم سماع الأذان أو تشغيل صوت مؤذن."
metadata: {"openclaw": {"emoji": "🕋","requires": {"bins": ["ffplay"]},"category": "islamic"}}
---
